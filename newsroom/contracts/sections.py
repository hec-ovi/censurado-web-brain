...
alias that was only relabelled in Spanish at render time), culture/literature
(slug ``literatura``, rendered "Cultura y literatura"), and socio-environmental
conflict/extractivism (slug ``ambiente``). This set mirrors the site's
...
SECTION_ENUM: tuple[str, ...] = ("tech", "world", "politics", "misterio-y-conspiracion", "literatura", "ambiente")
