...
`censurado-web` repository. They are the cross-layer contracts for what the harness
publishes.
...
Source repo: `censurado-web` (the reading platform); source paths: `contracts/*.json`.
