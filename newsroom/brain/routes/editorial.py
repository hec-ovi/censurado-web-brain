...
rest of the brain uses); writes go under the lock so a console edit and a running pipeline
never race on the connection. The router holds NO SQL: it calls the stores' existing
