...
- "pulido": todo lo demas que la mejora; el corrector final lo aplica sin frenar la nota. Ejemplos: "el titular tiene 12 palabras, acortalo a 4-7", "un verbo mas fuerte para el titular", "la bajada repite 'silencio' del titular", "sobra la ultima frase del cierre".
